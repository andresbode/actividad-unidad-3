...
//////Variables//////
Texture texturaCirculoAzul;
Sprite spriteCirculoAzul;
...
int main() {
	...
	texturaCirculoAzul.loadFromFile("circuloAzul.png");
	...
	spriteCirculoAzul.setTexture(texturaCirculoAzul);
	...
	spriteCirculoAzul.setPosition(336, 236);
